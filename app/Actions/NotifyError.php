...
class NotifyError
{
  ...
  {
    $json = '{"type":"bubble","body":{"type":"box","layout":"vertical","contents":[{"type":"text","text":"##topic","color":"#FCF5ED","size":"md","margin":"none"},{"type":"separator","margin":"sm"},{"type":"text","text":"##error","color":"#FCF5ED","margin":"sm","size":"xs"}]},"styles":{"header":{"separatorColor":"#BF3131","separator":true,"backgroundColor":"#7D0A0A"},"body":{"backgroundColor":"#CE5A67"}}}';
